...
function trialsLoopBegin(trialsLoopScheduler, snapshot) {
  return async () => {
    useRows = "0:12";
    trials = new TrialHandler({ psychoJS: psychoJS, nReps: 2, method: TrialHandler.Method.RANDOM, extraInfo: expInfo, trialList: TrialHandler.importConditions(psychoJS.serverManager, 'FondecytValues.csv', useRows), name: 'trials' }); //4
...
function trials_3LoopBegin(trials_3LoopScheduler, snapshot) {
  return async () => {
    useRows = "0:12";
    trials_3 = new TrialHandler({ psychoJS: psychoJS, nReps: 2, method: TrialHandler.Method.RANDOM, extraInfo: expInfo, trialList: TrialHandler.importConditions(psychoJS.serverManager, 'FondecytValuesR.csv', useRows), name: 'trials_3' }); //4
...
function trialRoutineEnd(snapshot) {
  return async function () {
    ...
    psychoJS.experiment.addData('VersionTrial', 'NonTrained-Short');
    nLoop++;
    routineTimer.reset();
    if (currentLoop === psychoJS.experiment) psychoJS.experiment.nextEntry(snapshot);
    return Scheduler.Event.NEXT;
