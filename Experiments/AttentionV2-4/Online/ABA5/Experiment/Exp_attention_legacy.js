...
let expName = 'Transports-A';  // from the Builder filename that created this script
let expInfo = {
...
function trialRoutineEnd(snapshot) {
  return async function () {
    ...
    // Reshuffle logic
    if (((phase === 2) && ((nLoop % Recurrency) === 0))) {
        util.shuffle(locations);
        console.log("Locations shuffled");
        shuffleStatus = "TRUE";
    }
...
const COMPLETION_URL = 'https://app.prolific.com/submissions/complete?cc=C1IBWX1X'
const CANCEL_URL = "https://app.prolific.com/submissions/complete?cc=C1IBWX1X";
