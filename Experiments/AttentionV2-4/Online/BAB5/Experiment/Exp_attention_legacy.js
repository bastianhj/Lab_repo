...
let expName = 'Transports-B';  // from the Builder filename that created this script
let expInfo = {
...
function trialRoutineEnd(snapshot) {
  return async function () {
    ...
    // --- LÓGICA DE SHUFFLE PARA BAB ---
    // Ahora hacemos shuffle si estamos en la Fase 1 O en la Fase 3
    if ((phase === 1 || phase === 3) && (nLoop % Recurrency === 0)) {
        util.shuffle(locations);
        console.log("Locations shuffled in phase " + phase);
        shuffleStatus = "TRUE";
    }
...
const COMPLETION_URL = 'https://app.prolific.com/submissions/complete?cc=C1MW98JW'
const CANCEL_URL = "https://app.prolific.com/submissions/complete?cc=C1MW98JW";
